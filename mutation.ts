...
import { getInformationFromPhone } from "./apifunctions.ts";
import { getInformationFromCountry } from "./apifunctions.ts";
import { ContactModel, ContactModelType } from "./contactdb.ts";
